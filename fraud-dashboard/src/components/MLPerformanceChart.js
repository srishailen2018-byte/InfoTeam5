...
const MLPerformanceChart = () => {
  ...
  return (
    <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '1.5rem', marginTop: '2rem' }}>
      <div className="chart-container chart-glow" style={{ backgroundColor: '#1f2937', padding: '1.5rem', borderRadius: '0.5rem', height: '400px', border: '1px solid rgba(51, 65, 85, 0.5)' }}>
        <h3 style={{ fontSize: '1rem', fontWeight: 'bold', marginBottom: '1.5rem', color: '#d1d5db' }}>Performance Over Time</h3>
        <Line options={options} data={lineData} />
      </div>

      <div className="chart-container chart-glow" style={{ backgroundColor: '#1f2937', padding: '1.5rem', borderRadius: '0.5rem', height: '400px', display: 'flex', flexDirection: 'column', alignItems: 'center', border: '1px solid rgba(51, 65, 85, 0.5)' }}>
